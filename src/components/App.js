  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <p className='footer'>Kitchen Cleaner 2018 by Lin Sriuthenchai • Recipe search powered by <a href='https://www.yummly.co/recipes'><img alt='Yummly' src='https://static.yummly.co/api-logo.png'/></a></p>
      </div>
    );
  }
}
